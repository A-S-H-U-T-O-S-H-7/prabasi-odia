  ...
  return (
    ...
    >
      ...
      <div className="pt-2 border-t border-[#D4C8C0]/20">
        <p className="text-sm font-medium text-[#2A1636] mb-3 md:mb-4">💼 Professional Details <span className="text-red-400">*</span></p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3 rounded-2xl border bg-white/50 focus:ring-2 transition-all duration-300 outline-none text-[#2A1636] placeholder:text-[#6B5E5A]/30 ${
