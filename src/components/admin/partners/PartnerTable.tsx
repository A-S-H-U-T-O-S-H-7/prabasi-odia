  ...
  if (loading) {
    return (
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/50 p-8 text-center shadow-sm">
        ...
        <p className="text-[#6B5E5A] mt-3">Loading partners...</p>
      </div>
    );
  }
  ...
  if (partners.length === 0) {
    return (
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/50 p-12 text-center shadow-sm">
        <p className="text-lg text-[#6B5E5A]">No partners found</p>
        <p className="text-sm text-[#6B5E5A]/60 mt-2">Click "Add Partner" to create one</p>
      </div>
    );
  }
        ...
        <table className="w-full">
          <thead className="bg-gradient-to-r from-[#6B1E5B]/5 via-[#8A2E72]/5 to-[#D9772B]/5 border-b border-[#E7D7E8]">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-semibold text-[#6B5E5A] uppercase tracking-wider">Partner</th>
